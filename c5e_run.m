...
psdx_fatigue_5e = (1/(fs*nfft3)) * abs(ff2).^2;
A = ones(1,4096);
B = zeros(1,4096);
psd_fatigue_5e = cat(2,psdx_fatigue_5e',B');
T5e = array2table (psd_fatigue_5e, 'VariableNames', {'PSD','fatigue'});
writetable(T5e,'psdc5e.xlsx','Sheet',1);