...
psdx_active_5s = (1/(fs*nfft3)) * abs(ff2).^2;
A = ones(1,4096);
B = zeros(1,4096);
psd_active_5s = cat(2,psdx_active_5s',A');
T5s = array2table (psd_active_5s, 'VariableNames', {'PSD','active'});
writetable(T5s,'psdc5s.xlsx','Sheet',1);