...
psdx_fatigue_3e = (1/(fs*nfft3)) * abs(ff2).^2;
pxx = pwelch(signal);
A = ones(1,4096);
B = zeros(1,4096);
psd_fatigue_3e = cat(2,psdx_fatigue_3e', B');
% T3e = array2table (psd_fatigue_3e, 'VariableNames', {'PSD','fatigue'});
% writetable(T3e,'psdc3e.xlsx','Sheet',1);