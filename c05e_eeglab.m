...
signalNoise = c05eeglabfatigue - mean(c05eeglabfatigue);
...
B_eeglab = zeros(1,4096);
psd_fatigue_eeglab_5e = cat(2,psdx_fatigue_eeglab',B_eeglab');
T5e_eeglab = array2table (psd_fatigue_eeglab_5e, 'VariableNames', {'PSD','Fatigue'});
writetable(Te_eeglab,'psdc5e_eeglab.xlsx','Sheet',1);
