...
signalNoise = c05eeglabactive - mean(c05eeglabactive);
...
psd_active_eeglab_5s = cat(2,psdx_active_eeglab', A_eeglab');
T5s_eeglab = array2table (psd_active_eeglab_5s, 'VariableNames', {'PSD','active'});
writetable(T5s_eeglab,'psdc5s_eeglab.xlsx','Sheet',1);
