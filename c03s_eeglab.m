...
signalNoise = c03eeglabactive - mean(c03eeglabactive);
...
psd_active_eeglab_3s = cat(2,psdx_active_eeglab', A_eeglab');
T3s_eeglab = array2table (psd_active_eeglab_3s, 'VariableNames', {'PSD','active'});
writetable(T3s_eeglab,'psdc3s_eeglab.xlsx','Sheet',1);
