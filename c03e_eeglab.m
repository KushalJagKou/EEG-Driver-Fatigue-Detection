...
signalNoise = c03eeglabfilteredfatigue - mean(c03eeglabfilteredfatigue);
...
B_eeglab = zeros(1,1024);
psd_fatigue_eeglab_3e = cat(2,psdx_fatigue_eeglab',B_eeglab');
T3e_eeglab = array2table (psd_fatigue_eeglab_3e, 'VariableNames', {'PSD','Fatigue'});
writetable(Te_eeglab,'psdc3e_eeglab.xlsx','Sheet',1);
